...
class music_cog(commands.Cog):
    ...
    async def play_music(self):
        if len(self.music_queue) > 0:
            ...
            #tratar de connectar al canal de voz si no esta conectado // voice channel if you are not already connected
            ...
            #remover primer elemento de la lista si no se esta escuchando //remove the first element as you are currently playing it
            self.music_queue.pop(0)
